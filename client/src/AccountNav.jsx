...
export default function AccountNav() {
    const { pathname } = useLocation(); // acquiring the pathname
    const subpage = pathname.split('/')?.[2] || 'profile'; // setting default if subpage is undefined
    console.log({subpage})

    function changeClass(type = null) {
        let classs = 'inline-flex px-4 py-2 ';
        // Ensure the default 'profile' is highlighted if subpage is not specified
        if (type === subpage) {
