  ...
  return (
       ...
       {action==='new' && (
        <form>
         ...
         <input type="text" placeholder='Your amazing location name'/>
         <h1 className='text-2xl'>Address</h1>
         <input type="text" placeholder='Your location details' />
         <h1 className='text-2xl'>Photos</h1>
         <p className='text-slate-400'>Add genuine updated photos...</p>
         <div className="flex gap-2">
         <input type="text" className='border border-none' placeholder=' Add images via link' />
         <button className='rounded-full px-8 py-2 bg-primary hover:bg-black text-white mt-3 px-4'>Add&nbsp; Photo</button>
         </div>
         <div className="p-8">
         <button className='text-slate-500 bg-white text-4xl  gap-1 inline-flex  text-2xl hover:text-black'>
         ...
         <textarea className='py-9 w-full border border-slate-200' placeholder='Describe your location with style!'></textarea>
         <h1 className='text-2xl'>Perks</h1>
         <p className='text-slate-400'>Select the perks that is unique in your place:</p>
         <div className="">
            <div className="mt-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6"> {/* where the md means medium screen and lg means large screen */}
                <label>
