...
export default function BookingPage() {
    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <h1 className="text-4xl font-semibold mb-4">{booking.place.title}, {booking.place.address}</h1>
           ...
           <div className="text-2xl mt-5 mb-4 bg-primary bg-opacity-80 text-white p-5 rounded-xl hover:bg-black">
            <p className="">ENJOY YOUR STAY <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
